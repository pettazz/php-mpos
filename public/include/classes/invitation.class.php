...
class Invitation extends Base {
  ...
  public function getInvitations($account_id) {
    ...
    $stmt = $this->mysqli->prepare("SELECT I.id AS id, I.account_id AS account_id, I.email AS email, I.token_id AS token_id, I.is_activated AS is_activated, I.time AS time, T.token AS token FROM $this->table I, tokens T WHERE I.account_id = ? AND T.id = I.token_id");
